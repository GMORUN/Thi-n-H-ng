...
gulp.task('babelfy', () => {
    return   gulp.src([
            ...
            // Other scripts
            './src/assets/scripts/jquery-3.2.1.min.js',
            './src/assets/scripts/jquery.bxslider.min.js',
            './src/assets/scripts/jquery.meanmenu.js',
            './src/assets/scripts/jquery.pogo-slider.js',
            './src/assets/scripts/lity.js',
